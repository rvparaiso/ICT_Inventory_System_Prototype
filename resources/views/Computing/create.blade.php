...
<div class="form-container">
                <div class="wrapper">
  <h4 class="card-header">Add Computing Device</h4>

  
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        <a class="btn btn-primary btn-sm" href="{{ route('Computing.index') }}"><i class="fa fa-arrow-left"></i> Back</a>
    </div>
  
        <form action="{{ route('Computing.store') }}" method="POST">
        @csrf
